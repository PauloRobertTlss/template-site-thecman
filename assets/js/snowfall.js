...
const LIFE_PER_TICK = (1000 / 60)/ 2;
//Number of snowflakes
const MAX_FLAKES = Math.min(20, (screen.width*0.1) / 1280 * 75);
...
function resetFlake(flake) {
    ...
    let z = flake.dataset.origZ = (Math.random() < 0.1) ? (Math.ceil(Math.random() * 100) + 2) : 0;

    let life = flake.dataset.life = (Math.ceil(Math.random() * 1000) + 6000); //Milliseconds
